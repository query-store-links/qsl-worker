...
const en: Dict = {
  ...
  "results.deps.label": "Dependencies",
  "results.deps.copy": "Copy dependency identity · {name}",
  "results.deps.framework.tooltip": "Framework dependency · {name} · {version} · click to copy",
  "results.deps.platform.tooltip": "Platform dependency · {name} · {version} · click to copy",
  "results.deps.versionRange": "min {min} · max tested {max}",
  "results.deps.minVersion": "min version {version}",
  "results.deps.maxTested": "max tested {version}",
  "results.deps.expand": "Show dependency graph",
  "results.deps.collapse": "Hide dependency graph",
  "results.deps.node.app": "App package · {name} · click to copy",
  "results.deps.node.framework": "Framework dependency · {name} · click to copy",
  "results.deps.badge.app": "app",
  "results.deps.badge.framework": "framework",
  "results.deps.declaredOnly": "declared · not in download set",
  "results.filter.placeholder": "Filter file names",
  "results.group.selectAll": "Select all variants of {name}",
  "results.group.expandAll": "Expand all",
  "results.group.collapseAll": "Collapse all",
  "results.tab.all": "All",
  ...
  "results.hash.copyAria": "Copy {algo}",
  "results.hash.copyLabel.sha256": "SHA-256",
  "results.hash.copyLabel.sha1": "SHA-1",
  "results.hash.verifyTooltip": "Copy verify-hash command ({algo})",
  "results.hash.verifyAria": "Copy verify-hash command ({algo})",
  "results.hash.shell.powershell": "PowerShell",
  "results.hash.shell.cmd": "Command Prompt",
  "results.hash.shell.bash": "Bash (Linux / macOS)",
  "results.hash.shell.powershellLabel": "PowerShell verify command ({algo})",
  "results.hash.shell.cmdLabel": "cmd.exe verify command ({algo})",
  "results.hash.shell.bashLabel": "Bash verify command ({algo})",
  "results.details.open": "Details",
  "results.details.openAria": "Show details for {name}",
  "results.details.close": "Close",
  "results.details.section.metadata": "Package",
  "results.details.section.actions": "Actions",
  "results.details.field.type": "Type",
  "results.details.field.arch": "Architecture",
  "results.details.field.size": "Size",
  "results.details.field.version": "Version",
  "results.details.hash.empty": "No {algo} checksum available for this file.",
  "results.details.verifyOn": "Verify on:",
  "results.details.copyUrl": "Copy URL",
  "results.details.copyName": "Copy file name",
  ...
  "stage.dcat.dependencies": "Reading dependency map",
  "stage.fe3.prerequisites": "Mapping package prerequisites",
  "stage.fe3.packageFound": "Found package",
  "stage.fe3.resolveUrls": "Resolving download URLs",
  "stage.fe3.resolveUrls.done": "Resolved download URLs",
  "stage.fe3.linkReceived": "Received download URL",
  "stage.fe3.packageResolved": "Resolved package",
...
const zh: Dict = {
  ...
  "results.deps.label": "依赖项",
  "results.deps.copy": "复制依赖标识 · {name}",
  "results.deps.framework.tooltip": "框架依赖 · {name} · {version} · 点击复制",
  "results.deps.platform.tooltip": "平台依赖 · {name} · {version} · 点击复制",
  "results.deps.versionRange": "最低 {min} · 最高测试 {max}",
  "results.deps.minVersion": "最低版本 {version}",
  "results.deps.maxTested": "最高测试版本 {version}",
  "results.deps.expand": "显示依赖关系图",
  "results.deps.collapse": "隐藏依赖关系图",
  "results.deps.node.app": "应用包 · {name} · 点击复制",
  "results.deps.node.framework": "框架依赖 · {name} · 点击复制",
  "results.deps.badge.app": "应用",
  "results.deps.badge.framework": "框架",
  "results.deps.declaredOnly": "已声明 · 不在下载列表中",
  "results.filter.placeholder": "按文件名过滤",
  "results.group.selectAll": "选择 {name} 的所有变体",
  "results.group.expandAll": "全部展开",
  "results.group.collapseAll": "全部折叠",
  "results.tab.all": "全部",
  "results.tab.appx": "APPX",
  ...
  "results.hash.copyAria": "复制 {algo}",
  "results.hash.copyLabel.sha256": "SHA-256",
  "results.hash.copyLabel.sha1": "SHA-1",
  "results.hash.verifyTooltip": "复制校验哈希命令（{algo}）",
  "results.hash.verifyAria": "复制校验哈希命令（{algo}）",
  "results.hash.shell.powershell": "PowerShell",
  "results.hash.shell.cmd": "命令提示符",
  "results.hash.shell.bash": "Bash (Linux / macOS)",
  "results.hash.shell.powershellLabel": "PowerShell 校验命令（{algo}）",
  "results.hash.shell.cmdLabel": "cmd.exe 校验命令（{algo}）",
  "results.hash.shell.bashLabel": "Bash 校验命令（{algo}）",
  "results.details.open": "详情",
  "results.details.openAria": "查看 {name} 的详情",
  "results.details.close": "关闭",
  "results.details.section.metadata": "包信息",
  "results.details.section.actions": "操作",
  "results.details.field.type": "类型",
  "results.details.field.arch": "架构",
  "results.details.field.size": "大小",
  "results.details.field.version": "版本",
  "results.details.hash.empty": "未提供此文件的 {algo} 校验和。",
  "results.details.verifyOn": "校验环境：",
  "results.details.copyUrl": "复制 URL",
  "results.details.copyName": "复制文件名",
  ...
  "stage.dcat.dependencies": "正在读取依赖关系",
  "stage.fe3.prerequisites": "正在映射安装包依赖项",
  "stage.fe3.packageFound": "已找到安装包",
  "stage.fe3.resolveUrls": "正在解析下载 URL",
  "stage.fe3.resolveUrls.done": "下载 URL 已解析",
  "stage.fe3.linkReceived": "已接收下载 URL",
  "stage.fe3.packageResolved": "已解析安装包",
